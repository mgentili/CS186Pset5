...
from gleaningwitbb import GleaningWitbb 
...
def test_bb():
    ...
    a1 = GleaningWitbb(1, 8, budget)
    a2 = GleaningWitbb(2, 10, budget)
    a3 = GleaningWitbb(3, 20, budget)
